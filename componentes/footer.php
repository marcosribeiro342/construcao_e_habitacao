<footer class="container-fluid mt-5 pt-5">
        <div class="row mt-4 contactos">
            <div class="col-12 sombra pt-2 pt-lg-5 ">
                <div class="container-fluid pt-lg-4 mt-2">

                    <div class="row linha_branca mt-5"></div>
                    
                    <div class="row mt-lg-4 pt-3">
                        <div class="col-12 text-center titulo">Contactos</div>
                    </div>
                    <div class="row mt-lg-5 pt-3 pt-lg-4  gap-4 gap-lg-0 justify-content-center">
                        <div class="col-12 col-lg-3 d-flex flex-column align-items-center gap-3 gap-lg-4 caixa_icone mt-2 pt-2">
                            <img src="imagens/tel.svg" alt="Telefone" class="icone">
                            <span class="mt-lg-2"><?= $contactos['telefone'] ?></span>
                        </div>
                        <div class="col-12 col-lg-3 d-flex flex-column align-items-center gap-3 gap-lg-4 caixa_icone especial mt-2 pt-2">
                            <img src="imagens/loc.svg" alt="Localização" class="icone">
                            <span class="mt-lg-2 text-center"><?= $contactos['morada'] ?></span>
                        </div>
                        <div class="col-12 col-lg-3 d-flex flex-column align-items-center gap-3 gap-lg-4 caixa_icone mt-lg-2 pt-2">
                            <img src="imagens/mail.svg" alt="E-mail" class="icone">
                            <span class="mt-lg-2 text-break"><?= $contactos['email'] ?></span>
                        </div>    
                    </div>
