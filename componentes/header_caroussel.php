...
$caroussel = getTodosCaroussel();
$empreendimentos = getTodosEmpreendimentos();
$quem_somos = getTodosMenuSimplesPeloNome("quem_somos");
        ...
        <div class="row justify-content-center navbar_row d-none d-lg-flex">
            ...
            <div class="col-auto">
                <nav class="d-flex justify-content-center align-items-end h-100 gap-3">
                    ...
                    <div class="dropdown">
                        <a class="" href="empreendimentos.php" class="<?= ($pagina_atual == "empreendimentos") ? 'active': '' ?>" role="button"  data-bs-toggle="dropdown" aria-expanded="false">
                          Empreendimentos
                        </a>
        ...
        <div class="row">
            <div class="col-12 px-0">
                <div id="carousel_topo" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-indicators mb-md-4 pb-md-2">
                    
                      <?php foreach($caroussel as $i => $c):?> 

                        <button type="button" data-bs-target="#carousel_topo" data-bs-slide-to="<?= $i; ?>" <?= ($i == 0) ? 'class="active" aria-current="true"' : ''; ?> aria-label="Slide <?= $i + 1 ?>"></button>
